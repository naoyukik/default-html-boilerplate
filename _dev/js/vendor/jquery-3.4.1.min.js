...
!(function (e, t) {
  ...
  k.extend({
    ...
    isPlainObject(e) {
      ...
      return (
        !(!e || o.call(e) !== '[object Object]')
          && (!(t = r(e)) || (typeof (n = v.call(t, 'constructor') && t.constructor) === 'function' && a.call(n) === l))
      );
    },
    isEmptyObject(e) {
      let t;
    ...
    map(e, t, n) {
      ...
      let o = 0;
      const a = [];
      if (d(e)) for (r = e.length; o < r; o++) (i = t(e[o], o, n)) != null && a.push(i);
  ...
  k.each('Boolean Number String Function Array Date RegExp Object Error Symbol'.split(' '), (e, t) => {
  ...
  const h = (function (n) {
    ...
    (T = se.setDocument = function (e) {
      ...
      return (
        r !== C
          ...
          (d.getElementsByTagName = ce((e) => (e.appendChild(C.createComment('')), !e.getElementsByTagName('*').length))),
          (d.getElementsByClassName = K.test(C.getElementsByClassName)),
          (d.getById = ce((e) => ((a.appendChild(e).id = k), !C.getElementsByName || !C.getElementsByName(k).length))),
          d.getById
          ...
          (d.qsa = K.test(C.querySelectorAll))
            && (ce((e) => {
              (a.appendChild(e).innerHTML = `<a id='${
                k
              }'></a><select id='${
                k
    ...
    ((b = se.selectors = {
      ...
      filter: {
            ...
            : function (e, t, n) {
              ...
              if (c) {
                ...
                if (((u = [m ? c.firstChild : c.lastChild]), m && p)) {
                  ...
                  (p
                      && (d = s = (r = (i = (o = (a = e)[k] || (a[k] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0]
                          === S && r[1]),
                  !1 === d)
                ) {
                  while ((a = (++s && a && a[l]) || (d = s = 0) || u.pop())) {
        ...
        PSEUDO(e, o) {
          let t;
          const a = b.pseudos[e] || b.setFilters[e.toLowerCase()] || se.error(`unsupported pseudo: ${e}`);
          return a[k]
            ? a(o)
            : a.length > 1
              ? ((t = [e, e, '', o]),
      ...
      for (
        ...
        if ((t = b.relative[e[s].type])) c = [be(we(c), t)];
          ...
          if ((t = b.filter[e[s].type].apply(null, e[s].matches))[k]) {
            ...
            return Ce(
              s > 1 && we(c),
              s > 1 && xe(e.slice(0, s - 1).concat({ value: e[s - 2].type === ' ' ? '*' : '' })).replace(B, '$1'),
              t,
              s < n && Ee(e.slice(s, n)),
              n < r && Ee((e = e.slice(n))),
              n < r && xe(e),
    ...
    (r, i) => {
      k.fn[r] = function (e, t) {
        ...
        return (
          ...
          this.length > 1 && (O[r] || k.uniqueSort(n), H.test(r) && n.reverse()),
          this.pushStack(n)
        );
      };
    },
  ...
  function ee(e, t, n) {
    ...
    if (void 0 === n && e.nodeType === 1) {
      if (((r = `data-${t.replace(Z, '-$&').toLowerCase()}`), typeof (n = e.getAttribute(r)) === 'string')) {
        try {
          n = (i = n) === 'true'
            || (i !== 'false' && (i === 'null' ? null : i === `${+i}` ? +i : K.test(i) ? JSON.parse(i) : i));
        } catch (e) {}
        J.set(e, t, n);
      } else n = void 0;
    }
  ...
  const se = function (e, t) {
    return (
      (e = t || e).style.display === 'none' || (e.style.display === '' && oe(e) && k.css(e, 'display') === 'none')
    );
  };
  ...
  function le(e, t, n, r) {
    ...
    let c = e.nodeType && (k.cssNumber[t] || (l !== 'px' && +u)) && ne.exec(k.css(e, t));
    if (c && c[3] !== l) {
      (u /= 2), (l = l || c[3]), (c = +u || 1);
  ...
  function fe(e, t) {
    for (var n, r, i, o, a, s, u, l = [], c = 0, f = e.length; c < f; c++) {
      (r = e[c]).style
        && ((n = r.style.display),
        t
          ? (n === 'none' && ((l[c] = Q.get(r, 'display') || null), l[c] || (r.style.display = '')),
          r.style.display === ''
              && se(r)
              && (l[c] = ((u = a = o = void 0),
              (a = (i = r).ownerDocument),
  ...
  function ve(e, t) {
    let n;
    return (
      (n = typeof e.getElementsByTagName !== 'undefined'
          ...
          if (l.nodeType === 1 && (e.type !== 'click' || !0 !== l.disabled)) {
            for (o = [], a = {}, n = 0; n < u; n++) {
              void 0 === a[(i = `${(r = t[n]).selector} `)]
                && (a[i] = r.needsContext ? k(i, this).index(l) > -1 : k.find(i, this, null, [l]).length),
              a[i] && o.push(r);
            }
  ...
  function Ie(n, r, i, o) {
    ...
    if (
      f
      && ((t = (e = we(r, n[0].ownerDocument, !1, n, o)).firstChild), e.childNodes.length === 1 && (e = t), t || o)
    ) {
  ...
  function et(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2) {
      ...
      r
        ...
        n !== 'margin' && (u -= k.css(e, `border${re[a]}Width`, !0, i)))
  ...
  function tt(e, t, n) {
    const r = Fe(e);
    let i = (!y.boxSizingReliable() || n) && k.css(e, 'boxSizing', !1, r) === 'border-box';
    let o = i;
    let a = _e(e, t, r);
    ...
    return (
      ((!y.boxSizingReliable() && i) || a === 'auto' || (!parseFloat(a) && k.css(e, 'display', !1, r) === 'inline'))
        && e.getClientRects().length
        && ((i = k.css(e, 'boxSizing', !1, r) === 'border-box'), (o = s in e) && (a = e[s])),
  ...
  k.extend({
    ...
    style(e, t, n, r) {
      if (e && e.nodeType !== 3 && e.nodeType !== 8 && e.style) {
        ...
        (o = typeof n) === 'string' && (i = ne.exec(n)) && i[1] && ((n = le(e, t, i)), (o = 'number')),
        n != null
            && n == n
            && (o !== 'number' || u || (n += (i && i[3]) || (k.cssNumber[s] ? '' : 'px')),
    ...
    k.cssHooks[u] = {
      ...
      set(e, t, n) {
        ...
        return (
          ...
          s && (r = ne.exec(t)) && (r[3] || 'px') !== 'px' && ((e.style[u] = t), (t = k.css(e, u))),
          Ze(0, t, s)
        );
      },
    };
  ...
  ((nt.propHooks = {
    _default: {
      ...
      set(e) {
        k.fx.step[e.prop]
          ? k.fx.step[e.prop](e)
          : e.elem.nodeType !== 1 || (!k.cssHooks[e.prop] && e.elem.style[Ge(e.prop)] == null)
            ? (e.elem[e.prop] = e.now)
  ...
  function dt(o, e, t) {
    ...
    var l = s.promise({
      ...
      tweens: [],
      createTween(e, t) {
        const n = k.Tween(o, l.opts, e, t, l.opts.specialEasing[e] || l.opts.easing);
  ...
  k.extend({
    prop(e, t, n) {
      ...
      if (o !== 3 && o !== 8 && o !== 2) {
        return (
          (o === 1 && k.isXMLDoc(e)) || ((t = k.propFix[t] || t), (i = k.propHooks[t])),
          void 0 !== n
            ? i && 'set' in i && void 0 !== (r = i.set(e, n, t))
              ? r
              : (e[t] = n)
    ...
    trigger(e, t, n, r) {
      ...
      if (
        ...
        n.nodeType !== 3
          ...
          (u = d.indexOf(':') < 0 && `on${d}`),
          ((e = e[k.expando] ? e : new k.Event(d, typeof e === 'object' && e)).isTrigger = r ? 2 : 3),
          (e.namespace = h.join('.')),
      ...
      return this.map(function () {
        ...
        .map(function (e, t) {
          ...
          return n == null
            ? null
            : Array.isArray(n)
              ? k.map(n, (e) => ({ name: t.name, value: e.replace(At, '\r\n') }))
  ...
  k.extend({
    ...
    ajax(e, t) {
      ...
      if (
        (v.data && v.processData && typeof v.data !== 'string' && (v.data = k.param(v.data, v.traditional)),
        _t(It, v, t, T),
        h)
      ) return T;
      for (i in ((g = k.event && v.global) && k.active++ == 0 && k.event.trigger('ajaxStart'),
 ...
 try {
  ...
  k.each(['ajaxStart', 'ajaxStop', 'ajaxComplete', 'ajaxError', 'ajaxSuccess', 'ajaxSend'], (e, t) => {
    k.fn[t] = function (e) {
      return this.on(t, e);
    };
  }),
  (k.expr.pseudos.animated = function (t) {
    return k.grep(k.timers, (e) => t === e.elem).length;
  }),
  (k.offset = {
    setOffset(e, t, n) {
      let r;
